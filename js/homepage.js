...
const tasmanianDevil = new Animal('Tasmanian Devil', description(`The Tasmanian devil (Sarcophilus harrisii) (palawa kani: purinina)[3] is a carnivorous marsupial of the family Dasyuridae. Until recently, it was only found on the island state of Tasmania,
  ...
  Tasmanian devil's large head and neck allow it to generate among the strongest bites per unit body mass of any extant predatory land mammal. It hunts prey and scavenges on carrion.`), `A predator, then eat meat from other animals such as wallabies and wombats`, 'mammal');
...
cover its claws.`), `Plant eaters, they munch on shrubs and grasses`, 'mammal');
...
the safety of a tree.`), `Small insects and spiders`, 'reptile');
...
approximately 80 cm in length.`), `other animals (sponges & jellyfish), sea plants`, 'reptile');
...
ceremonial purposes.`), `Carnivore, they eat animals like kangaroos, rabbits, lizards and birds`, 'reptile');
...
Florida`), `Plants matter like fruit, insects and small animals like mice amd lizards`, 'bird');
...
face and its upper bill is black. Its reddish-coloured tail is patterned with black bars.`), `Insects and smalll animals including snakes, frogs and lizards`, 'bird');
...
and Tasmania) have more prominent scalloping.`), `Fruit, seeds and other plant material`, 'bird');
