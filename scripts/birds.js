...
const displayWelcomeContent = () => {
  ...
  contentParagraph.style.padding = '15px 0';
  contentParagraph.style.maxWidth = '1000px';
...
const displayContent = (index) => {
  ...
  birdDescription.textContent = !seemore
    ? birdContent[index].description.split('|')[0]
    : birdContent[index].description.split('|').join(' ');
